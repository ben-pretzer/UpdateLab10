...
//	ST7735_DrawBitmap(5,160,Ninja2,65,34);
	portCEdgeInit();
	portEEdgeInit();
	SysTick_Init();
	EnableInterrupts();
	...
	while(1)
		...
		while ((checkPlayer1() ==1)){
				...
				ST7735_FillScreen(0x0000); 
				ST7735_DrawBitmap(70,160,Ninja1Flipped,20,33);
				ST7735_DrawBitmap(5,160,Ninja2,65,34);
				ST7735_SetCursor(0,0);
				ST7735_OutString("Player 1 attacks\n");
				ST7735_OutString("Player 1 health: ");
...
int mainTest(void){
  ...
  //ST7735_DrawBitmap(5,160,Ninja1,23,37); //THIS PICTURE IS 100% CORRECT DONT ALTER
	//ST7735_DrawBitmap(5,160,Ninja2,65,34); //THIS PICTURE IS 100% CORRECT DONT ALTER
	//ST7735_DrawBitmap(70,160,Ninja3,45,36); // THIS PICTURE IS 100% CORRECT DONT ALTER
	//ST7735_DrawBitmap(60,160,Ninja1Flipped,20,33); //THIS PICTURE IS 100% CORRECT DONT ALTER
